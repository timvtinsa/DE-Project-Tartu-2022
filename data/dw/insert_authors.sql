INSERT INTO authors (id, first_name, last_name, gender, citations_count, h_index, author_affiliation_id)
 VALUES 
(1, 'Csaba', 'Balazs', 'M', 11869, 55, 1),
(2, 'Pavel', 'Nadolsky', 'M', 42571, 53, 2),
(3, 'C.-P.', 'Yuan', 'X', 37423, 83, 3),
(4, 'C.', 'Balázs', 'X', 0, 0, 0),
...
(20, 'Damian', 'Swift', 'M', 5754, 38, 8),
(21, 'Bruno', 'Merín', 'M', 10257, 47, 9),
(22, 'Luisa', 'Rebull', 'F', 12669, 58, 10),
